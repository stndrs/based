  ...
  let query =
    ...
    |> select.where([
      sql.column("created_at")
        |> sql.gt(value.text("2024-01-01"), of: sql.value),
...
pub fn select_subquery_test() {
  ...
  let subquery =
    ...
    |> select.where([
      sql.column("name")
      |> sql.eq(value.text("Human Person"), of: sql.value),
    ])
...
pub fn select_or_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      |> sql.or(
        sql.column("email")
        |> sql.eq(value.text("human.person@example.com"), of: sql.value),
      ),
    ])
    |> select.to_query
...
pub fn where_lt_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("age")
      |> sql.lt(value.int(65), of: sql.value),
    ])
    |> select.to_query
...
pub fn where_lt_eq_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("age")
      |> sql.lt_eq(value.int(65), of: sql.value),
    ])
    |> select.to_query
...
pub fn where_not_eq_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("status")
      |> sql.not_eq(value.text("inactive"), of: sql.value),
    ])
    |> select.to_query
...
pub fn multiple_where_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("age")
        |> sql.gt(value.int(18), of: sql.value),
      sql.column("status")
        |> sql.eq(value.text("active"), of: sql.value),
    ])
    |> select.to_query
  ...
  let query =
    ...
    |> select.join(orders, on: [
      ...
      sql.column("orders.status")
        |> sql.eq(value.text("completed"), of: sql.value),
    ])
    |> select.where([
      sql.column("users.age")
        |> sql.gt(value.int(20), of: sql.value),
      sql.column("users.active")
        |> sql.eq(value.bool(True), of: sql.value),
    ])
    |> select.to_string
...
pub fn having_test() {
  ...
  let query =
    ...
    |> select.having([
      sql.count("*")
      |> sql.gt(value.int(5), of: sql.value),
    ])
    |> select.to_query
  ...
  let query =
    ...
    |> select.having([
      sql.count("*")
        |> sql.gt(value.int(5), of: sql.value),
      sql.avg("salary")
        |> sql.gt(value.float(50_000.0), of: sql.value),
    ])
    |> select.to_query
...
pub fn complex_query_with_order_by_test() {
  ...
  let query =
    ...
    |> select.having([
      sql.count("*")
      |> sql.gt(value.int(10), of: sql.value),
    ])
...
pub fn complex_queried_with_aggregation_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("total_salary")
      |> sql.gt(value.float(1_000_000.0), of: sql.value),
    ])
    |> select.to_query
...
pub fn complex_for_update_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("user_id")
        |> sql.eq(value.int(5), of: sql.value),
      sql.column("balance")
        |> sql.gt_eq(value.float(1000.0), of: sql.value),
    ])
...
pub fn for_update_with_join_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("orders.status")
      |> sql.eq(value.text("pending"), of: sql.value),
    ])
    |> select.for_update
    |> select.to_query
  ...
  let query =
    ...
    |> select.where([
      sql.column("event_date")
        |> sql.eq(value.date(date), of: sql.value),
      sql.column("event_timestamp")
        |> sql.eq(value.timestamp(time), of: sql.value),
    ])
    |> select.to_query
...
pub fn time_type_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      |> sql.eq(value.time(time_of_day), of: sql.value),
    ])
    |> select.to_query
...
pub fn duration_type_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      |> sql.eq(value.interval(dur), of: sql.value),
    ])
    |> select.to_query
...
pub fn different_value_types_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("id")
        |> sql.eq(value.int(123), of: sql.value),
      sql.column("price")
        |> sql.gt(value.float(19.99), of: sql.value),
      sql.column("is_active")
        |> sql.eq(value.bool(True), of: sql.value),
      sql.column("description")
        |> sql.eq(value.null, of: sql.value),
    ])
    |> select.to_query
...
pub fn between_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("price")
      |> sql.between(value.float(10.0), value.float(50.0), of: sql.value),
    ])
    |> select.to_query
...
pub fn complex_between_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("total")
        |> sql.between(value.float(100.0), value.float(1000.0), of: sql.value),
      sql.column("created_at")
        |> sql.between(
