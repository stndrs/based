  ...
  let query =
    ...
    |> select.where([
      sql.column("created_at")
        |> column.gt(value.text("2024-01-01"), of: sql.value),
      sql.column("user_id")
        |> column.eq(subquery, of: select.to_subquery),
    ])
    |> select.to_query
...
pub fn select_or_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      |> sql.or(
        sql.column("email")
        |> column.eq(value.text("human.person@example.com"), of: sql.value),
      ),
    ])
    |> select.to_query
...
pub fn where_lt_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("age")
      |> column.lt(value.int(65), of: sql.value),
    ])
    |> select.to_query
...
pub fn where_lt_eq_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("age")
      |> column.lt_eq(value.int(65), of: sql.value),
    ])
    |> select.to_query
...
pub fn where_not_eq_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("status")
      |> column.not_eq(value.text("inactive"), of: sql.value),
    ])
    |> select.to_query
...
pub fn multiple_where_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      sql.column("status")
        |> column.eq(value.text("active"), of: sql.value),
    ])
    |> select.to_query
  ...
  let query =
    ...
    |> select.where([
      sql.column("users.age")
        |> column.gt(value.int(20), of: sql.value),
...
pub fn complex_for_update_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      sql.column("balance")
        |> column.gt_eq(value.float(1000.0), of: sql.value),
    ])
...
pub fn for_update_with_join_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("orders.status")
      |> column.eq(value.text("pending"), of: sql.value),
    ])
    |> select.for_update
    |> select.to_query
  ...
  let query =
    ...
    |> select.where([
      sql.column("event_date")
        |> column.eq(value.date(date), of: sql.value),
      sql.column("event_timestamp")
        |> column.eq(value.timestamp(time), of: sql.value),
    ])
    |> select.to_query
...
pub fn time_type_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      |> column.eq(value.time(time_of_day), of: sql.value),
    ])
    |> select.to_query
...
pub fn duration_type_test() {
  ...
  let query =
    ...
    |> select.where([
      ...
      |> column.eq(value.interval(dur), of: sql.value),
    ])
    |> select.to_query
...
pub fn different_value_types_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("id")
        |> column.eq(value.int(123), of: sql.value),
      sql.column("price")
        |> column.gt(value.float(19.99), of: sql.value),
      sql.column("is_active")
        |> column.eq(value.bool(True), of: sql.value),
      sql.column("description")
        |> column.eq(value.null, of: sql.value),
    ])
    |> select.to_query
...
pub fn between_test() {
  ...
  let query =
    ...
    |> select.where([
      sql.column("price")
      |> column.between(value.float(10.0), value.float(50.0), of: sql.value),
    ])
    |> select.to_query
